<header class="header black_nav clearfix element_to_stick">
    <div class="container">
        <div id="logo">
            <a href="index.html">
                <img src="{{asset('storage/img/logo_sticky.svg')}}" width="162" height="35" alt="">
            </a>
        </div>
        ...
        <nav class="main-menu">
            ...
            <ul>
                <li class="submenu">
                    <a href="javascript:" class="show-submenu">Home</a>
                    <ul>
                ...
                <li class="submenu">
                    <a href="javascript:" class="show-submenu">Listing</a>
                    <ul>
                        <li class="third-level"><a href="javascript:">List pages</a>
                            <ul>
                        ...
                        <li class="third-level"><a href="javascript:">Detail pages</a>
                            <ul>
                        ...
                        <li class="third-level"><a href="javascript:">OpenStreetMap</a>
                            <ul>
                ...
                <li class="submenu">
                    <a href="javascript:" class="show-submenu">Other Pages</a>
                    <ul>
                ...
                <li><a href="javascript:">Buy this template</a></li>
            </ul>
        </nav>
    </div>
</header>